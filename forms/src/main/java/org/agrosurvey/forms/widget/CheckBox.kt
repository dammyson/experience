...
class CheckBox : LinearLayout, FieldView {
    ...
    private fun initView() {
        val view = View.inflate(context, R.layout.widget_form_check_box, null)
    ...
    private fun LinearLayout.setListItems(items: List<String>, defaultPosition: Int = 0) {
        val checkBoxes = mutableListOf<CheckBox>()
        items.forEach {
            CheckBox(context).run {
                text = it
