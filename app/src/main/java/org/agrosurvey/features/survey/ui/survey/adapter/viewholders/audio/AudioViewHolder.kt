...
import com.agrosurvey.databinding.ItemAudioBinding
...
class AudioViewHolder(val context: Context, private val binding: ItemAudioBinding):
    ...
    override fun bind(questionAndResponse: QuestionAndResponse){
        ...
        beginTransaction().replace(
            R.id.audio_frame_layout,
            AudioFragment.newInstance(
                questionAndResponse = questionAndResponse!!,
                filePathInterface = object : AudioFragment.FilePathInterface{
